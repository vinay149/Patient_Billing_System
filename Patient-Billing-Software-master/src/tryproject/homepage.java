...
public class homepage extends javax.swing.JFrame {
    ...
    public homepage() {
       // setSize(400,768);
        ...
        JLabel background=new JLabel(new ImageIcon(getClass().getResource("/tryproject/back.png")));
        add(background);
    ...
    private void initComponents() {
        ...
        orgdetails.setText("Update Organisation Details");
        ...
        newentry.setText("New Patient Entry");
